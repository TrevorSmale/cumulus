...
| term | description |
|---|---|
| Azure Functions | Provides a solution for building highly reliable and secure serverless apps supporting multiple programming languages. You can build apps using simple serverless functions with the ability to scale as needed to meet demand. It enables you to focus on building apps without the concerns for server resources.|
